...
export default function App() {
  ...
  return (
    <div>
      ...
      >
        <div
          className=" max-w-[400px] p-5 text-center mx-auto bg-[#F8F9FE] border-4 rounded-2xl  border-dotted w-full h-full flex flex-col justify-center items-center cursor-pointer"
          onDrop={handleDrop}
